...
When a task involves a specific well-known site (flights, shopping, maps, job boards), navigate there
directly with a natural language query in the URL or search box rather than guessing at generic search terms.
